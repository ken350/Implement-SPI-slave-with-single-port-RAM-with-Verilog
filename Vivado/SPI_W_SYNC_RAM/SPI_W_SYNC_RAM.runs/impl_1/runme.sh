...
HD_PWD='C:/Users/kenka/OneDrive/Desktop/kareem_wassim_diploma/DESIGN/project_2/Vivado/SPI_W_SYNC_RAM/SPI_W_SYNC_RAM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_w_RAM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SPI_w_RAM.tcl -notrace
