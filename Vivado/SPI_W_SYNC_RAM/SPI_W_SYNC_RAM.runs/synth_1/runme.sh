...
HD_PWD='C:/Users/kenka/OneDrive/Desktop/kareem_wassim_diploma/DESIGN/project_2/Vivado/SPI_W_SYNC_RAM/SPI_W_SYNC_RAM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_w_RAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPI_w_RAM.tcl
